...
import static ua.com.javarush.kkushka.AVE1.BruteForce.BruteForce.bruteForce;

public class BruteForceFile {


    public static void bruteForseFile() {
        Path pathToFileForCoder = Path.of("src/ua/com/javarush/kkushka/AVE1/CoderDecoder/FileforCoder.txt").toAbsolutePath();
        Path pathToFileWithBrute = Path.of("src/ua/com/javarush/kkushka/AVE1/BruteForce/FileWithBrute.txt").toAbsolutePath();
