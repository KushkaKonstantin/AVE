package ua.com.javarush.kkushka.AVE1.Coder;
import java.io.*;
...
public class CoderFile {
    ...
    public static void coderFile(int key) {
        Path pathOfOriginalText = Path.of("src/ua/com/javarush/kkushka/AVE1/CoderDecoder/FileWithText.txt").toAbsolutePath();
